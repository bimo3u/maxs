					...
					<div style="display: table-row; height: 100%;">
						<div class="adminmenubar">
							<div class="stickythingy">
								...
								<div style="text-align: center; padding: 30px; font-size: 10px;"><?php echo uilang("Developed by") ?><br><a target="_blank" class="textlink" style="color: lime;" href="https://bimocorner.com">https://bimocorner.com/</a><br><br>Tugas PKL:<br><br>BIMO TRI UTOMO PKL<br></a></div>
							</div>
						</div>
